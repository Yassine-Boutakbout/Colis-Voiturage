...
function backgroundSlider () {
    if ($('.background-slider').length) {          
        $(".background-slider").vegas({
            ...
            transition: [ 'fade' ],
            slides: [
                { src: "img/alice-donovan-rouse-58619-unsplash.jpg" },
                { src: "img/andrew-kambel-269602-unsplash.jpg" },
                { src: "img/morgan-mcdonald-348426-unsplash.jpg" },
                { src: "img/gerrie-van-der-walt-469049-unsplash.jpg" },
                { src: "img/oscar-nilsson-288758-unsplash.jpg" }
            ]
        });
    };
}
